...
class Simple_Flag_Links_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$this->profiles = apply_filters( 'simple_flag_default_profiles', array(
			...
			'greece' => array(
				'label'   => __( 'Greece URI', 'ssiw' ),
				'pattern' => '<li class="flag-greece-%s %s"><a href="%s" %s></a></li>',
			),
			'portugal' => array(
				'label'   => __( 'Portugal URI', 'ssiw' ),
				'pattern' => '<li class="flag-portugal-%s %s"><a href="%s" %s></a></li>',
			),
			'mexico' => array(
      ...
      'hungary' => array(
				'label'   => __( 'Hungary URI', 'ssiw' ),
				'pattern' => '<li class="flag-hungary-%s %s"><a href="%s" %s></a></li>',
			),
		) );
